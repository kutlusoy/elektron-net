...
public:
    CMainParams() {
        ...
        nDefaultPort = 8333;
        nPruneAfterHeight = 197280; // MANDATORY_PRUNE_DEPTH: prune once first checkpoint is reached; retain last 137 days
        m_assumed_blockchain_size = 10; // ~137-day window at 60s blocks (informational)
