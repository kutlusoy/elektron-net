...
QT_TRANSLATE_NOOP("bitcoin-core", "Scanning UTXO set…"),
QT_TRANSLATE_NOOP("bitcoin-core", "Failed to scan UTXO set during wallet initialization"),
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet balances recovered from the current UTXO set. Pruned transaction history is unavailable."),
